...
graph TB
    ...
    subgraph PY["Python Engine · Quant Plane"]
        ...
        STR["Strategy Runtime<br/>execution_runner · fulcrum/*"]
...
│   └── fulcrum/                # concrete straddle strategy family
