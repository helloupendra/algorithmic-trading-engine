...
namespace AlgoTrading.Infrastructure.Persistence.Configurations
{
    ...
    public class LiveTickConfiguration : IEntityTypeConfiguration<LiveTick>
    {
        public void Configure(EntityTypeBuilder<LiveTick> builder)
        {
            ...
            // (Id, ReceivedUtc): live_ticks is a TimescaleDB hypertable partitioned
            // by ReceivedUtc, and a hypertable's unique index must include the
            // partitioning column. Id is still generated by the database.
