...
import { IconLayers, IconPlay, IconShield, IconStop } from '../../components/icons'
import type {
  LivePosition,
  RiskRules,
  StrategyActiveRun,
 ...
 * overall stop-loss / target progress bars, and — while the run is live — an
 * inline editor whose Save PATCHes the rules so the guard applies them on its
 * next sweep. Shown even when nothing is set, so the operator sees "No risk
 * rules · Set" rather than a silent absence of protection.
 */
    ...
    >
      ...
      {view && (
        <>
          ...
          <RiskSection runId={runId} view={view} isActive={isActive} />
